...
const TW_PURPLE =
  "text-purple-600 bg-purple-100/60 dark:text-purple-400 dark:bg-purple-900/20";
...
const StatusBadge = ({ status }: { status: string }) => {
  ...
  return (
    <span
      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold tracking-wider whitespace-nowrap ${cfg.tw}`}
    >
      {cfg.label}
    </span>
  );
